function colormap = cbrewer2_ns(cname, ncol, interp_method, interp_space, varargin)

% Natalia Sucher's version of CBREWER2 that automatically installs the
% package in the path without grahic interface
