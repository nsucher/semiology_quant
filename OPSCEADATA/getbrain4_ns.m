...
if strcmpi(pt_name,'MNI'); pt_name='cvs_avg35_inMNI152'; end 
...
if ~[exist([ptdir '_lh_pial.mat'])==2]; ptdir=['/nataliasucher/Desktop/UCSF/Coding/OPSCEA/OPSCEADATA/' pt_name '/Imaging/Meshes/' pt_name]; end
