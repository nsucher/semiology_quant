function [c_h] = ctmr_gauss_plot_edited(cortex,elecmatrix,weights,cax,addl,CM,gsp,opscea_path)
% function [c_h]=ctmr_gauss_plot(cortex,elecmatrix,weights)
%
% projects electrode locations (elecmatrix) onto their cortical spots in 
...
% and then by Natalia Sucher for quantitative semiology in 2023
